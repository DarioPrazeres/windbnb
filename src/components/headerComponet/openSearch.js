export default function openSearchSection(value) {
    ...
    switch (value) {
        case 'guest': guestForm.style.border = 'solid 1px #333333'; cityForm.style.border = 'none';detailGuest.style.display='block'; detailCity.style.display='none'; break;
        case 'city': cityForm.style.border = 'solid 1px #333333'; guestForm.style.border = 'none';; detailGuest.style.display='none'; detailCity.style.display='block'; break;
    }
}