...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shim = __webpack_require__(35);
	
	var _withSelector = __webpack_require__(94);
	
	var _reactBatchedUpdates = __webpack_require__(79);
	
	var _batch = __webpack_require__(29);
	
	var _useSelector = __webpack_require__(26);
	
	var _connect = __webpack_require__(23);
	
	var _exports = __webpack_require__(74);
...
/***/ function(module, exports) {
	...
	exports.default = openSearchSection;
	function openSearchSection(value) {
	    var searchSeaction = document.querySelector('section.search');
	    var cityForm = document.querySelector('div.cityForm');
	    var guestForm = document.querySelector('div.guest-form');
	    var detailCity = document.querySelector('div.detail-city');
	    var detailGuest = document.querySelector('div.detail-guest');
	    searchSeaction.style.display = 'flex';
	    switch (value) {
	        case 'guest':
	            guestForm.style.border = 'solid 1px #333333';cityForm.style.border = 'none';detailGuest.style.display = 'block';detailCity.style.display = 'none';break;
	        case 'city':
	            cityForm.style.border = 'solid 1px #333333';guestForm.style.border = 'none';;detailGuest.style.display = 'none';detailCity.style.display = 'block';break;
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.decrementTotal = exports.updateTotal = exports.counterTotalSlice = undefined;
	
	var _toolkit = __webpack_require__(4);
	
	//const count = useSelector((state)=>state.count.value);
	var counterTotalSlice = exports.counterTotalSlice = (0, _toolkit.createSlice)({
	  name: 'counterTotal',
	  initialState: {
	    value: 0
	  },
	  reducers: {
	    updateTotal: function updateTotal(state, action) {
	      state.value += 1;
	    },
	    decrementTotal: function decrementTotal(state) {
	      if (state.value > 0) {
	        state.value -= 1;
	      } else {
	        state.value = 0;
	...
	var _counterTotalSlice$ac = counterTotalSlice.actions,
	    updateTotal = _counterTotalSlice$ac.updateTotal,
	    decrementTotal = _counterTotalSlice$ac.decrementTotal;
	exports.updateTotal = updateTotal;
	exports.decrementTotal = decrementTotal;
	exports.default = counterTotalSlice.reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = SearchSeaction;
	...
	var _searchWhite = __webpack_require__(90);
	
	var _searchWhite2 = _interopRequireDefault(_searchWhite);
	
	var _stays = __webpack_require__(9);
	
	var _stays2 = _interopRequireDefault(_stays);
	
	var _gpsIcon = __webpack_require__(88);
	
	var _gpsIcon2 = _interopRequireDefault(_gpsIcon);
	
	var _ControlChild = __webpack_require__(48);
	
	var _ControlChild2 = _interopRequireDefault(_ControlChild);
	
	var _ControlAdult = __webpack_require__(47);
	
	var _ControlAdult2 = _interopRequireDefault(_ControlAdult);
	
	var _reactRedux = __webpack_require__(6);
	
	var _openSearch = __webpack_require__(7);
	
	var _openSearch2 = _interopRequireDefault(_openSearch);
	
	var _nameCity = __webpack_require__(19);
	
	var _search = __webpack_require__(20);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var cities = ["Helsinki", "Vaasa", "Turku", "Oulu", "All Cities"];
	
	function SearchSeaction() {
	    var nameCity = (0, _reactRedux.useSelector)(function (state) {
	        return state.city.value;
	    });
	    var search = (0, _reactRedux.useSelector)(function (state) {
	        return state.searchCity.value;
	    });
	    var dispatch = (0, _reactRedux.useDispatch)();
	    var countT = (0, _reactRedux.useSelector)(function (state) {
	        return state.counterT.value;
	    });
	    ...
	    var handleChange = function handleChange(e) {
	        ...
	        dispatch((0, _nameCity.newCity)(searchTerm));
	    };
	    _react2.default.useEffect(function () {
	        var results = cities.filter(function (city) {
	            return city.toLocaleLowerCase().includes(searchTerm);
	        });
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "div",
	                { className: "input-form cityForm", onClick: function onClick() {
	                        return (0, _openSearch2.default)('city');
	                    } },
	                _react2.default.createElement(
	                    "label",
	                    null,
	                ...
	                _react2.default.createElement("input", { type: "text", placeholder: "Add Location", value: searchTerm, onChange: handleChange })
	            ),
	            _react2.default.createElement(
	                "div",
	                { className: "input-form guest-form", onClick: function onClick() {
	                        return (0, _openSearch2.default)('guest');
	                    } },
	                _react2.default.createElement(
	                    "label",
	                    null,
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "button",
	                    { className: "submitSearch", onClick: function onClick() {
	                            console.log(search);
	                            hideSearchSection();
	                            dispatch((0, _search.newSearch)(searchParameter(nameCity, countT)));
	                            console.log(search);
	                        } },
	                    _react2.default.createElement("img", { src: _searchWhite2.default, alt: "icon search white" }),
	                    _react2.default.createElement(
	                        "p",
	                        null,
	                        "Search"
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                searchResults.map(function (item) {
	                    return _react2.default.createElement(CitySearch, { cityName: item });
	                })
	            ),
	            _react2.default.createElement(
	                "div",
	                { className: "detail-guest" },
	                _react2.default.createElement(_ControlAdult2.default, null),
	                _react2.default.createElement(_ControlChild2.default, null)
	            )
	        )
	    );
	}
	function CitySearch(props) {
	    ...
	    return _react2.default.createElement(
	        "div",
	        { className: "tipsCity", onClick: function onClick() {
	                if (props.cityName !== undefined) {
	                    dispatch((0, _nameCity.newCity)(props.cityName));
	                    console.log(nameCity);
	                }
	                hideSearchSection();
	            } },
	        _react2.default.createElement("img", { src: _gpsIcon2.default, alt: "item of location" }),
	        _react2.default.createElement(
	            "p",
	            null,
	            props.cityName,
	...
	function searchParameter(city, guests) {
	    var datta = _stays2.default;
	    var result = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.zerarByAmount = exports.incrementByAmount = exports.decrement = exports.increment = exports.counterSlice = undefined;
	...
	var counterSlice = exports.counterSlice = (0, _toolkit.createSlice)({
	  ...
	  reducers: {
	    ...
	    zerarByAmount: function zerarByAmount(state, action) {
	      state.value = 0;
	    }
	  }
	});
	...
	var _counterSlice$actions = counterSlice.actions,
	    ...
	    zerarByAmount = _counterSlice$actions.zerarByAmount;
	exports.increment = increment;
	exports.decrement = decrement;
	exports.incrementByAmount = incrementByAmount;
	exports.zerarByAmount = zerarByAmount;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.decrementAdult = exports.incrementAdult = exports.counterAdultSlice = undefined;
	
	var _toolkit = __webpack_require__(4);
	
	var counterAdultSlice = exports.counterAdultSlice = (0, _toolkit.createSlice)({
	  name: 'counterAdult',
	  initialState: {
	    value: 0
	  },
	  reducers: {
	    incrementAdult: function incrementAdult(state, action) {
	      // Redux Toolkit allows us to write "mutating" logic in reducers. It
	      // doesn't actually mutate the state because it uses the Immer library,
	      // which detects changes to a "draft state" and produces a brand new
	      // immutable state based off those changes
	    ...
	    decrementAdult: function decrementAdult(state) {
	      if (state.value > 0) {
	        state.value -= 1;
	      } else {
	        state.value = 0;
	...
	// Action creators are generated for each case reducer function
	var _counterAdultSlice$ac = counterAdultSlice.actions,
	    incrementAdult = _counterAdultSlice$ac.incrementAdult,
	    decrementAdult = _counterAdultSlice$ac.decrementAdult;
	exports.incrementAdult = incrementAdult;
	exports.decrementAdult = decrementAdult;
	exports.default = counterAdultSlice.reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.newCity = exports.cityNameslice = undefined;
	
	var _toolkit = __webpack_require__(4);
	
	var cityNameslice = exports.cityNameslice = (0, _toolkit.createSlice)({
	    name: 'nameCity',
	    initialState: {
	        value: 'All'
	    },
	    reducers: {
	        newCity: function newCity(state, action) {
	            state.value = action.payload;
	        }
	    }
	});
	var newCity = cityNameslice.actions.newCity;
	exports.newCity = newCity;
	exports.default = cityNameslice.reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.newSearch = exports.searchslice = undefined;
	
	var _toolkit = __webpack_require__(4);
	
	var _stays = __webpack_require__(60);
	
	var _stays2 = _interopRequireDefault(_stays);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var searchslice = exports.searchslice = (0, _toolkit.createSlice)({
	    name: 'search',
	    initialState: {
	        value: _stays2.default
	    },
	    reducers: {
	        newSearch: function newSearch(state, action) {
	            state.value = action.payload;
	        }
	    }
	});
	var newSearch = searchslice.actions.newSearch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutPropertiesLoose2 = _interopRequireDefault(__webpack_require__(14));
	
	var _hoistNonReactStatics = _interopRequireDefault(__webpack_require__(56));
	
	var _react = _interopRequireWildcard(__webpack_require__(1));
	
	var _reactIs = __webpack_require__(67);
	
	var _selectorFactory = _interopRequireDefault(__webpack_require__(72));
	...
	var _Subscription = __webpack_require__(28);
	
	var _useIsomorphicLayoutEffect = __webpack_require__(31);
	...
	var _useSyncExternalStore = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifyPlainObject = _interopRequireDefault(__webpack_require__(33));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useReduxContext = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultMemoize = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchSection = __webpack_require__(16);
	
	var _SearchSection2 = _interopRequireDefault(_SearchSection);
	
	var _Places = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _counterAdult = __webpack_require__(18);
	
	var _counterAdult2 = _interopRequireDefault(_counterAdult);
	
	var _totalGuest = __webpack_require__(8);
	
	var _totalGuest2 = _interopRequireDefault(_totalGuest);
	
	var _nameCity = __webpack_require__(19);
	
	var _nameCity2 = _interopRequireDefault(_nameCity);
	...
	exports.default = (0, _toolkit.configureStore)({
	  reducer: {
	    ...
	    counterAd: _counterAdult2.default,
	    counterT: _totalGuest2.default,
	    city: _nameCity2.default,
	    searchCity: _search2.default
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Header() {
	    return _react2.default.createElement(
	        "header",
	        null,
	        _react2.default.createElement("img", { src: _logo2.default, className: "logo", alt: "logo of windbnb" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchGuest = __webpack_require__(51);
	
	var _SearchGuest2 = _interopRequireDefault(_SearchGuest);
	
	var _SearchCity = __webpack_require__(50);
	
	var _SearchCity2 = _interopRequireDefault(_SearchCity);
	
	var _ButtonSearch = __webpack_require__(49);
	
	var _ButtonSearch2 = _interopRequireDefault(_ButtonSearch);
	...
	function Search() {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SearchGuest2.default, null),
	        _react2.default.createElement(_ButtonSearch2.default, null)
	    );
	}
	...
	function ControlAdult() {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                { className: "controls",
	                    onClick: function onClick() {
	                        dispatch((0, _counterAdult.decrementAdult)());
	                        if (count > 0) {
	                            dispatch((0, _totalGuest.decrementTotal)());
	                        }
	                    } },
	                "-"
	            ),
	            ...
	            _react2.default.createElement(
	                "button",
	                { className: "controls control-add",
	                    onClick: function onClick() {
	                        dispatch((0, _counterAdult.incrementAdult)());
	                        dispatch((0, _totalGuest.updateTotal)());
	                    }
	                },
	                "+"
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ControlChild(prop) {
	    var countT = (0, _reactRedux.useSelector)(function (state) {
	        return state.counterT.value;
	    });
	
	    var _useState = (0, _react.useState)(countT),
	    ...
	    var counterAd = (0, _reactRedux.useSelector)(function (state) {
	        return state.counterAd.value;
	    });
	    var dispatch = (0, _reactRedux.useDispatch)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SearchCity() {
	    return _react2.default.createElement(
	        "button",
	        { className: "city-btn", onClick: function onClick() {
	                return (0, _openSearch2.default)('city');
	            } },
	        _react2.default.createElement("img", { className: "", src: _search2.default, alt: "lupa icon" })
	    );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SearchCity() {
	    ...
	    return _react2.default.createElement(
	        ...
	        nameCity === 'All' ? 'Helsinki' : nameCity,
	        ", Finland"
	    );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SearchGuest() {
	    return _react2.default.createElement(
	        "button",
	        { className: "guest-btn", onClick: function onClick() {
	                return (0, _openSearch2.default)('guest');
	            } },
	        "Add guest"
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Places() {
	    var city = (0, _reactRedux.useSelector)(function (state) {
	        return state.city.value;
	    });
	    var search = (0, _reactRedux.useSelector)(function (state) {
	        return state.searchCity.value;
	    });
	    var qtdRoom = (0, _reactRedux.useSelector)(function (state) {
	        return state.counterT.value;
	    });
	    ...
	    var _useState3 = (0, _react.useState)('All'),
	        ...
	        cityName = _useState4[0],
	        setCityName = _useState4[1];
	
	    var _useState5 = (0, _react.useState)((0, _SearchSection.searchParameter)(cityName, qtd)),
	        _useState6 = _slicedToArray(_useState5, 2),
	        hostComponent = _useState6[0],
	        setHost = _useState6[1];
	
	    (0, _react.useEffect)(function () {
	        setCityName(city);
	        setQtd(qtdRoom);
	        setHost((0, _SearchSection.searchParameter)(city, qtd));
	    }, [city, qtdRoom]);
	    return _react2.default.createElement(
	        "section",
	        { className: "placeSection" },
	        _react2.default.createElement(
	            "div",
	        ...
	        _react2.default.createElement(
	            "section",
	            { className: "hosts" },
	            hostComponent.map(function (data) {
	                return _react2.default.createElement(Banner, { key: data.id, datta: data });
	            })
	        )
	    );
	}
	function BannerImg(props) {
	    return _react2.default.createElement("img", { src: props.photo, alt: "banner", className: "bannerHost" });
	}
	function Banner(props) {
	    return _react2.default.createElement(
	        "div",
	        { className: "host-section" },
	        _react2.default.createElement(BannerImg, { photo: props.datta.photo }),
	        _react2.default.createElement(
	            "div",
	            { className: "hostDetail" },
	            _react2.default.createElement(
	                "span",
	                { className: "super", style: { display: styleSuperGuest(props.datta.superHost) } },
	                "Super Host"
	            ),
	            _react2.default.createElement(
	                "p",
	            ...
	            _react2.default.createElement(
	                "div",
	                { className: "rating" },
	                _react2.default.createElement("img", { src: _star2.default, alt: "star rating" }),
	                _react2.default.createElement(
	                    "p",
	                    null,
	                    props.datta.rating
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "static/media/logo.817e3360.svg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),ca=__webpack_require__(85);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindActionCreators = _interopRequireDefault(__webpack_require__(77));
	
	var _wrapMapToProps = __webpack_require__(24);
	
	var _invalidArgFactory = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifySubselectors = _interopRequireDefault(__webpack_require__(73));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = _interopRequireDefault(__webpack_require__(68));
	
	var _connect = _interopRequireDefault(__webpack_require__(23));
	...
	var _useStore = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.assign = __webpack_require__(61);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"

/***/ },
/* 89 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var h=__webpack_require__(1),n=__webpack_require__(35);function p(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q="function"===typeof Object.is?Object.is:p,r=n.useSyncExternalStore,t=h.useRef,u=h.useEffect,v=h.useMemo,w=h.useDebugValue;
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.da862010.js.map